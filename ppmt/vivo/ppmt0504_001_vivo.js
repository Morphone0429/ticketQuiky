...
const config = {
  ...
  orcSleepTime: 2000, // orc 刷新频率  根据调试机型设置
};

// 真机按钮 信息
const point = {
  //  按钮信息 ------start ------
  originSixModePoint: { x: 577, y: 1035 }, // 单个盲盒随机发货  √
  originSingleModePoint: { x: 215, y: 1035 }, // 整盒含6个盲盒  √

  originSendToHomePoint: {
    x: 131,
    y: !config.sixMode && !config.singleMode ? 1000 : 1325,
  }, // 送到家按钮 √
  ...
  originalQuickBtnPointWithOutCarPoint: { x: 638, y: 2195 }, // 立即购买按钮(无加入购物车) √
  originalQuickBtnPointWithCarPoint: { x: 841, y: 2195 }, // 立即购买按钮(有加入购物车) √
  originSurePoint: { x: 538, y: 2093 }, // 选择购买方式页面有货时 确定按钮 √
  originThisMarkPoint: { x: 538, y: 1495.0 }, // 确定订单页面 确认稳点信息  就是这家按钮 √
  originNoProdPoint: { x: 538, y: 1184 }, // 没货提示 我知道了按钮  √
  originknowMailPoint: { x: 538, y: 1461.0 }, // √
  originSureInfoAndPayPoint: { x: 834, y: 2200.0 }, //确认订单页面 确认信息并支付 √
  //  按钮信息 ------end -----
};
