...
let point = {
  //  按钮信息 ------start ------
  originSingleModePoint: { x: 262, y: 1277 }, // 整盒含6个盲盒  1
  originSixModePoint: { x: 706, y: 1277 }, // 单个盲盒随机发货  1
  originSendToHomePoint: {
    x: 163,
    y: !config.sixMode && !config.singleMode ? 1245 : 1625, 
  }, // 送到家按钮   1
  ...
  originalQuickBtnPointWithOutCarPoint: { x: 746, y: 2631 }, // 立即购买按钮(无加入购物车) 1
  originalQuickBtnPointWithCarPoint: { x: 980, y: 2631}, // 立即购买按钮(有加入购物车) 1
  originSurePoint: { x: 629, y:2515 }, // 选择购买方式页面有货时 确定按钮  //1
  originThisMarkPoint: { x:629, y: 1800.0 }, // 确定订单页面 确认稳点信息  就是这家按钮 //1
  originNoProdPoint: { x: 631.5, y: 1468.5 }, // 没货提示 <我知道了>按钮  //1
  originknowMailPoint: { x:629, y: 1759.0 }, // 请确认收货地址  确认无误按钮  //1
  originSureInfoAndPayPoint: { x: 972, y: 2640.0 }, //确认订单页面 确认信息并支付  //1
  originBackScreenPoint: { x: 65, y: 211.0 }, // 返回上一页左上角图标 //1
  //  按钮信息 ------end -----
};
...
let main = () => {
  ...
  function accessUsers() {
    let androidIds = ['0886aa40c2308ede', '67ba03268b21b722']
