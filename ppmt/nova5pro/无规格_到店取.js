...
let androidIds = ['1116b0a825135171']
...
let point = {
  ...
  originalQuickBtnPointWithOutCarPoint: { x: 639, y: 2247 }, // 立即购买按钮(无加入购物车)  ok1
  originalQuickBtnPointWithCarPoint: { x: 837, y: 2247 }, // 立即购买按钮(有加入购物车)  ok1
  originSurePoint: { x: 538, y: 2150.0 }, // 选择购买方式页面有货时 确定按钮  ok1
  originThisMarkPoint: { x: 539, y: 1523 }, // 确定订单页面 确认们店信息  就是这家按钮 ok1
  originNoProdPoint: { x: 536, y: 1183 }, // 没货提示 <我知道了>按钮  ok1
  originknowMailPoint: { x: 538, y: 1486 }, // 请确认收货地址  确认无误按钮  ok1
  originSureInfoAndPayPoint: { x: 836, y: 2253.0 }, //确认订单页面 确认信息并支付 //ok1
  originBackScreenPoint: { x: 58, y: 146.0 },  //ok1
  //  按钮信息 ------end -----
};
