...
let point = {
  //  按钮信息 ------start ------
  originSixModePoint: { x:597, y: 1102 }, // 单个盲盒随机发货 1
  originSingleModePoint: { x: 220, y: 1103 }, // 整盒含6个盲盒 1
  originSendToHomePoint: {
    x: 138,
    y: !config.sixMode && !config.singleMode ? 1072 : 1396,
  }, // 送到家按钮  1
  ...
  originalQuickBtnPointWithOutCarPoint: { x: 639, y: 2264 }, // 立即购买按钮(无加入购物车) 1
  originalQuickBtnPointWithCarPoint: { x: 840, y: 2263 }, // 立即购买按钮(有加入购物车) 1
  originSurePoint: { x: 541, y:2166 }, // 选择购买方式页面有货时 确定按钮 1
  originThisMarkPoint: { x: 538, y:1546 }, // 确定订单页面 确认稳点信息  就是这家按钮 1
  originNoProdPoint: { x: 550, y: 1241 }, // 没货提示 <我知道了>按钮  1
  originknowMailPoint: { x: 545, y: 1519.0 }, // 请确认收货地址  确认无误按钮 1
  originSureInfoAndPayPoint: { x: 835, y: 2268}, //确认订单页面 确认信息并支付  1
  originBackScreenPoint: { x: 61, y: 170.0 }, //1
  //  按钮信息 ------end -----
};
