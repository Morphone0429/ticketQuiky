...
let androidIds = ["67ba03268b21b722", "6e3352764bff933f"];

// 真机按钮 信息
let point = {
  //  按钮信息 ------start ------
  originSixModePoint: { x: 597, y: 1090 }, // 单个盲盒随机发货
  originSingleModePoint: { x: 220, y: 1090 }, // 整盒含6个盲盒
  originSendToHomePoint: {
    x: 138,
    y: !config.sixMode && !config.singleMode ? 1061 : 1386,
  }, // 送到家按钮
  ...
  originalQuickBtnPointWithOutCarPoint: { x: 639, y: 2250 }, // 立即购买按钮(无加入购物车)
  originalQuickBtnPointWithCarPoint: { x: 837, y: 2250 }, // 立即购买按钮(有加入购物车)
  originSurePoint: { x: 538, y: 2153 }, // 选择购买方式页面有货时 确定按钮
  originThisMarkPoint: { x: 538, y: 1534 }, // 确定订单页面 确认稳点信息  就是这家按钮
  originNoProdPoint: { x: 534, y: 1199 }, // 没货提示 <我知道了>按钮
  originknowMailPoint: { x: 538, y: 1498 }, // 请确认收货地址  确认无误按钮
  originSureInfoAndPayPoint: { x: 836, y: 2255.0 }, //确认订单页面 确认信息并支付
  originBackScreenPoint: { x: 58, y: 158.0 },
  //  按钮信息 ------end -----
};
